...
class SiTech
{
	 ...
	 *
	 * @access	public
	 * @param	string	Filename to check if it's readable or not.
	 * @return	bool
	 */
	 ...
	 *
	 * @access  public
	 * @param	string	Class name to load into the scope.
	 */
	...
	/**
	 * Include a file. This is pretty much useless for procedural code, but useful when it comes
	 * to classes and definitions. An exception is thrown whenever a file cannot be read or
	 * including it fails.
	 *
	 * @access  public
	 * @param   string  Filename of file to include
	 * @param   bool	True to include only once, false to include more than once.
	 */
	 ...
	 *
	 * @access  public
	 * @param   string  Interface name to load
	 */
